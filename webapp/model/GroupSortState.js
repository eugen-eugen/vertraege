sap.ui.define([
	...
	return BaseObject.extend("interseroh.vertraege.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias interseroh.vertraege.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Geschaeftspartner, or by 
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Geschaeftspartner");
			}
