sap.ui.define([
	...
	return BaseController.extend("interseroh.vertraege.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("VertragSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("VertragSet", oData);
