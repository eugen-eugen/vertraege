sap.ui.define([
	...
	return BaseObject.extend("interseroh.vertraege.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias interseroh.vertraege.model.ListSelector
		 */
		 ...
		 * @return {interseroh.vertraege.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
