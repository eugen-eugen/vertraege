						...
						success: function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("Vertragsnummer");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.Vertragsnummer === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							return this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "text",
									value: "VertraspositionSet (" + iNumberOfItems + ")"
								}),
								success: function () {
