sap.ui.define([
	"interseroh/vertraege/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Geschaeftspartner").length, 1, "The sorting by Geschaeftspartner returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Geschaeftspartner and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Geschaeftspartner");
